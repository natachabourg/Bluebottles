...
simu_cd015 = find(~cellfun(@isempty,strfind(simu_names_small, '8_0deg'))) %02
simu_cdrelou = find(~cellfun(@isempty,strfind(simu_names_small, '8_randeg'))) %02

simu_cd02 = find(~cellfun(@isempty,strfind(simu_names_small, '8_varydeg'))) %03
